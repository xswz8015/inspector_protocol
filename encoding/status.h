...
enum class Error {
  ...
  CBOR_NO_INPUT = 0x0e,
  CBOR_INVALID_START_BYTE = 0x0f,
  CBOR_UNEXPECTED_EOF_EXPECTED_VALUE = 0x10,
  CBOR_UNEXPECTED_EOF_IN_ARRAY = 0x11,
  CBOR_UNEXPECTED_EOF_IN_MAP = 0x12,
  CBOR_INVALID_MAP_KEY = 0x14,
  CBOR_STACK_LIMIT_EXCEEDED = 0x15,
