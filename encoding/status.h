...
enum class Error {
  ...
  JSON_PARSER_INVALID_TOKEN = 3,
  JSON_PARSER_INVALID_NUMBER = 4,
  JSON_PARSER_INVALID_STRING = 5,
  JSON_PARSER_UNEXPECTED_ARRAY_END = 6,
  JSON_PARSER_COMMA_OR_ARRAY_END_EXPECTED = 7,
  JSON_PARSER_ARRAY_END_EXPECTED = 8,
  ...
  JSON_PARSER_OBJECT_END_EXPECTED = 13,
  JSON_PARSER_VALUE_EXPECTED = 14,
};
