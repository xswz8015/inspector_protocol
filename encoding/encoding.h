...
enum class Error {
  ...
  BINDINGS_MANDATORY_FIELD_MISSING = 0x22,
  BINDINGS_BOOL_VALUE_EXPECTED = 0x23,
  BINDINGS_INT32_VALUE_EXPECTED = 0x24,
  BINDINGS_DOUBLE_VALUE_EXPECTED = 0x25,
  BINDINGS_STRING_VALUE_EXPECTED = 0x26,
  BINDINGS_STRING8_VALUE_EXPECTED = 0x27,
  BINDINGS_BINARY_VALUE_EXPECTED = 0x28,
};
